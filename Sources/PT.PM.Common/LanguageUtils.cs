...
namespace PT.PM.Common
{
    public static class LanguageUtils
    {
        ...
        public static readonly Dictionary<Language, LanguageInfo> LanguageInfos = new Dictionary<Language, LanguageInfo>
        {
            ...
            [Sql] = new LanguageInfo(Sql, new[] { ".sql", ".ddl" }, true, "SQL"),
            [PlSql] = new LanguageInfo(PlSql, new[] { ".sql", ".ddl", ".pks", ".pkb", ".pls" }, true, "PL/SQL"),
            [TSql] = new LanguageInfo(TSql, new [] { ".sql", ".ddl", ".qry" }, true, "T-SQL"),
            [MySql] = new LanguageInfo(MySql, new [] { ".sql", ".ddl", ".qry" }, true, "MySql"),
